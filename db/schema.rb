...
ActiveRecord::Schema.define(version: 2019_05_03_140012) do
  ...
  create_table "green_spaces", force: :cascade do |t|
    ...
    t.string "address"
    t.float "acres"
    t.index ["name"], name: "index_green_spaces_on_name", unique: true
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["green_space_id"], name: "index_reviews_on_green_space_id"
